 ...
 */
export const DailySalesSummary = memo(
  ({ cashRegister }: DailySalesSummaryProps) => {
    ...
    return (
      <div
        className={`${isDark ? "bg-[#1E293B] border-[#334155]" : "bg-white border-gray-100"} rounded-2xl p-6 shadow-md border`}
      >
        <h2
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            <h3
              className={`font-semibold text-base border-b pb-2 ${isDark ? "text-gray-300 border-[#334155]" : "text-gray-700 border-gray-200"}`}
            >
              Resumen Financiero
            </h3>
