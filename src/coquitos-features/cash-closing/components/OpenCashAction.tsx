    ...
    <div className={`${isDark ? 'bg-[#1E293B] border-[#334155]' : 'bg-white border-gray-100'} rounded-2xl p-6 shadow-xl border-2`}>
      <div className="flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <button
          ...
          className={`flex items-center gap-3 px-6 py-3 bg-gradient-to-r ${isDark ? 'from-emerald-600 to-green-500' : 'from-emerald-500 to-green-600'} text-white rounded-xl hover:shadow-2xl hover:shadow-emerald-500/50 transition-all duration-200 font-bold shadow-lg`}
        >
