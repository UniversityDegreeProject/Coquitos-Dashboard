...
export const ClientsPage = () => {
  ...
  const [searchFilters, setSearchFilters] =
    useState<SearchClientsSchema>(searchDefaultValues);
  ...
  const setOpenModalCreate = useClientStore(
  ...
  const isSearchPending =
    ...
    searchFilters.type !== debouncedType;
  ...
  useEffect(() => {
    const searchHasBeenChange: boolean =
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      {/* Modals */}
      {modalMode === "create" && (
        <FormClientModal currentParams={currentParams} />
      )}
      {modalMode === "update" && (
        <FormClientModal currentParams={currentParams} />
      )}
