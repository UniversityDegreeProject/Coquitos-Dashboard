...
/**
 * Componente reutilizable para mostrar una tarjeta de estadística de órdenes
...
export const OrderStatCard = memo(({
  ...
  const defaultIconColor = iconColor || (isDark ? 'text-[#F59E0B]' : 'text-[#275081]');
