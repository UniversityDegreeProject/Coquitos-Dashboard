...
export const OrdersPage = () => {
  ...
  const [searchFilters, setSearchFilters] =
    useState<SearchOrdersSchema>(searchDefaultValues);

  // * Zustand
  const isCreateOrderModalOpen = useOrderStore(
    useShallow((state) => state.isCreateOrderModalOpen)
  );
  const openCreateOrderModal = useOrderStore(
    useShallow((state) => state.openCreateOrderModal)
  );
