...
import type { GetProductsResponse } from "../interfaces";

interface ProductPaginationProps {
  paginationData: Omit<GetProductsResponse, "data">;
...
export const ProductPagination = memo(({
  ...
  // Opciones de límite por página (específico para productos: 6, 12, 18, ..., 100)
  const limitOptions = [6, 12, 18, 24, 100];
