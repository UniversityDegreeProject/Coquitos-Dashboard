        ...
        <div className="flex flex-col sm:flex-row gap-3">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <select
                  ...
                  className={`w-full pl-12 pr-10 py-3.5 rounded-xl border ${isDark ? 'bg-[#1E293B] border-[#334155]' : 'bg-white border-[#E5E7EB]'} shadow-sm ${isDark ? 'border-[#334155] focus:border-[#F59E0B] focus:ring-[#F59E0B]/20' : 'border-[#E5E7EB] focus:border-[#275081] focus:ring-[#275081]/20'} focus:ring-2 ring-offset-1 outline-none transition-all duration-200 ${isDark ? 'text-[#F8FAFC]' : 'text-[#1F2937]'} appearance-none cursor-pointer hover:${isDark ? 'border-[#475569]' : 'border-[#D1D5DB]'} ${isLoadingCategories ? 'opacity-50' : ''}`}
                >
          ...
          <div className="flex flex-col gap-2 min-w-[160px]">
            <div className="space-y-2">
              ...
              <label className={`flex items-center px-4 py-3.5 rounded-xl border ${isDark ? 'bg-[#1E293B] border-[#334155]' : 'bg-white border-[#E5E7EB]'} shadow-sm transition-colors duration-200 cursor-pointer hover:${isDark ? 'border-[#475569]' : 'border-[#D1D5DB]'} ${lowStockFilter ? isDark ? 'border-[#F59E0B] ring-2 ring-offset-1 ring-[#F59E0B]/20' : 'border-[#275081] ring-2 ring-offset-1 ring-[#275081]/20' : ''}`}>
                <input
                  type="checkbox"
