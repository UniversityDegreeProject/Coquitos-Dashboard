...
const saleApi: StateCreator<SaleState, [["zustand/devtools", never]], []> = (
  set,
  get
) => ({
  ...
  openCreateSaleModal: () =>
    set({ isCreateSaleModalOpen: true }, false, "Open create sale modal"),

  closeCreateSaleModal: () =>
    set(
      { isCreateSaleModalOpen: false, cartItems: [] },
      false,
  ...
  clearCart: () => set({ cartItems: [] }, false, "Clear cart"),
...
export const useSaleStore = create<SaleState>()(
  devtools(saleApi, { name: "sale-store" })
);
