  ...
  return (
    <div className={`space-y-2 ${className}`}>
      ...
      <div className="relative group">
        {Icon && (
          <Icon className="absolute left-4 top-4 w-5 h-5 text-gray-400 group-focus-within:text-[#275081] transition-colors" />
        )}
        <Controller
          name={name}
          control={control}
          render={({ field }) => (
            <textarea
              ...
              } focus:ring-4 outline-none transition-all text-gray-800 placeholder:text-gray-400 disabled:opacity-50 disabled:cursor-not-allowed disabled:bg-gray-50 resize-none`}
